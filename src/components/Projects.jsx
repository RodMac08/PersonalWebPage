        ...
        <div className="w-full max-w-4xl text-center">
          ...
          <div className="mb-8">
            ...
            <p data-aos="fade-up" className="font-monts text-base md:text-lg flex items-center justify-center gap-2">
              Web project, for recommendations and monitoring of habits, focused mainly on emotional well-being, where tools such as TypeScript, Angular, Node.js, Express, and MySQL are used. In this school project (for now), we work under the SCRUM methodology (Participating in the role of SCRUM Master).
            </p>
